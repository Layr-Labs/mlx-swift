...
// backend only on macOS with a deployment target >= 26.2, otherwise use the
// no-op stub. This keeps unsupported Apple targets (older macOS, iOS, tvOS,
// visionOS) on the stub instead of compiling the RDMA implementation.
//
...
#include <AvailabilityMacros.h> // defines __MAC_OS_X_VERSION_MIN_REQUIRED
